...
<body class="bg-slate-50 min-h-screen text-slate-800">
    ...
    <header class="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a href="#vitals-app-url" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold rounded-xl text-sm transition-all border border-emerald-200/60 active:scale-95 shadow-sm">
